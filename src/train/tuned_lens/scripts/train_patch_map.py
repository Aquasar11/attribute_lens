...
Usage:
    python -m train.tuned_lens.scripts.train_patch_map --config configs/train/patch_map/lowrank.yaml
...
from train.tuned_lens.bbox_data import create_bbox_dataloaders
from train.tuned_lens.config import PatchMapFullConfig
from train.tuned_lens.contrastive_trainer import PatchMapLightningModule
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", type=str, default="configs/train/patch_map/lowrank.yaml",
