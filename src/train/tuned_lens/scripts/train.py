...
from train.tuned_lens.config import TunedLensConfig
from train.tuned_lens.data import create_imagenet_dataloaders
from train.tuned_lens.model import VisionModelWrapper
from train.tuned_lens.sweep import run_sweep
from train.tuned_lens.trainer import TunedLensLightningModule
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", type=str, default="configs/train/tuned_lens/default.yaml",
