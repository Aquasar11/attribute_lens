"""Training script for direct_lens.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a direct_lens")
    parser.add_argument("--config", default="configs/train/direct_lens/default.yaml")
